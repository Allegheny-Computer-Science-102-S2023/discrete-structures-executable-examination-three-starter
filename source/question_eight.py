"""Question eight for an executable examination."""
...
# Instructions:
# Reorder the instructions in this function
...
def question_eight_a():
    """Run question eight-a."""
    # Do not edit this function
    separator = " / "
    question_eight_output_a = str(compute_ratios([1, 2, 7, 6], [1, 2, 0, 3]))
    question_eight_output_a = question_eight_output_a + separator + str(compute_ratios([0, 0, 0, 0], [1, 2, 4, 3]))
    question_eight_output_a = question_eight_output_a + separator + str(compute_ratios([1, 2, 7, 6], [1, 2, 5, 3]))
    return question_eight_output_a
...
# Instructions:
# Provide an implementation of the following function so that
# it works according to the following function description
...
def question_eight_b():
    """Run question eight-b."""
    # Do not edit this function
    separator = " / "
    question_eight_output_b = str(is_factor(2, 10))
    question_eight_output_b = question_eight_output_b + separator + str(is_factor(3, 9))
    question_eight_output_b = question_eight_output_b + separator + str(is_factor(3, 10))
    question_eight_output_b = question_eight_output_b + separator + str(is_factor(10, 10))
    return question_eight_output_b
...
# --> bark method: return a formatted string that adheres to this pattern:
...
class Dog:
    ...
    def bark(self, message: str) -> str:
        ...
        return f"Arf, {self.age} says '{message}'"
...
def create_barking_dogs(dog_input_list: List[List[str | int]]) -> str:
    ...
    for current_input_dog_list in dog_input_list:
        current_dog = Dog(current_input_dog_list[0], current_input_dog_list[1])
...
def question_eight_c():
    """Run question eight-c."""
    # Do not edit this function
    separator = " / "
    question_eight_output_c = create_barking_dogs([["Bosco", 8, "I love playing with toys!"]])
    question_eight_output_c = question_eight_output_c + separator + create_barking_dogs([["Miles", 4, "Throw the ball!"]])
    return question_eight_output_c
...
def run_question_eight():
    """Run all of the subquestions in question eight."""
    # call the function for question eight-a
    output = question_eight_a()
    print(output)
    # call the function for question eight-b
    output = question_eight_b()
    print(output)
    # call the function for question eight-c
    output = question_eight_c()
    print(output)
